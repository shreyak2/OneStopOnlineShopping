...
INSERT INTO User_Session
(Customer_ID, Login_time)
VALUES(8, (getdate()-'06:11:07'));
INSERT INTO User_Session
(Customer_ID, Login_time)
VALUES(9, (getdate()-'08:11:30'));
INSERT INTO User_Session
(Customer_ID, Login_time)
VALUES(10, (getdate()));
INSERT INTO User_Session
...
/* PLease check and modify, does PRICE Column needs to be inserted ? */
/*Removed Price from the create query for shopping cart item*/
...
/*Insert into payment amount should be same as order please clear all fields in payment and reinsert and generate invoice accordingly */
...
VALUES('Helio', 'South of denver');

INSERT INTO Territory
(Territoy_Name, Territory_Desc)
VALUES('trio', 'North of denver');


INSERT INTO Territory
(Territoy_Name, Territory_Desc)
VALUES('Lakewood', 'SouthEast of denver');


INSERT INTO Territory
(Territoy_Name, Territory_Desc)
VALUES('Bellevue', 'SouthWest of denver');


INSERT INTO Territory
(Territoy_Name, Territory_Desc)
VALUES('Redmondlake', 'downtown denver');


INSERT INTO Territory
(Territoy_Name, Territory_Desc)
VALUES('kirkland', 'northwest of denver');


INSERT INTO Territory
(Territoy_Name, Territory_Desc)
VALUES('centralpark', 'north of colorado');


INSERT INTO Territory
(Territoy_Name, Territory_Desc)
VALUES('timequare', 'South of colorado');


INSERT INTO Territory
(Territoy_Name, Territory_Desc)
VALUES('pentagonpark', 'east of colorado');


INSERT INTO Territory
(Territoy_Name, Territory_Desc)
VALUES('lynwood', 'west of colorado');
